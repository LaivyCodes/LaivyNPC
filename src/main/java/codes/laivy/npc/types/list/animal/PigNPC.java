...
public class PigNPC extends AgeableEntityLivingNPC {
    ...
    public static @NotNull PigNPC fastInstance(@NotNull List<OfflinePlayer> player, @NotNull Location location, @Nullable Object object) {
        return new PigNPC(player, location);
    }
