...
public class SquidNPC extends EntityLivingNPC {
    ...
    public static @NotNull SquidNPC fastInstance(@NotNull List<OfflinePlayer> players, @NotNull Location location, @Nullable Object object) {
        return new SquidNPC(players, location);
    }
