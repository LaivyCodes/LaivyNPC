...
public class CraftBlock extends ObjectExecutor {
    ...
    public @NotNull codes.laivy.npc.mappings.utils.classes.others.objects.Block getNMSBlock() {
        return new codes.laivy.npc.mappings.utils.classes.others.objects.Block(laivynpc().getVersion().getMethodExec("CraftBlock:getNMSBlock").invokeInstance(this));
    }
