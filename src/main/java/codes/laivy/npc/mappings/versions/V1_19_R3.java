...
public class V1_19_R3 extends V1_19_R2 {
    ...
    public void loadClasses() {
        ...
        load(V1_19_R3.class, "Entity:Human", new EntityHuman.EntityHumanClass("net.minecraft.world.entity.player.EntityHuman"));
        ...
        load(V1_19_R3.class, "Entity:Zombie:Giant", new ZombieGiant.ZombieGiantClass("net.minecraft.world.entity.monster.EntityGiantZombie"));
        // EntityPlayer
        ...
        load(V1_19_R3.class, "MojangsonParser", new ClassExecutor("net.minecraft.nbt.MojangsonParser"));
        //
