...
import codes.laivy.npc.mappings.utils.classes.datawatcher.DataWatcherItem;
...
public class V1_9_R2 extends V1_9_R1 {
    ...
    public @NotNull Map<String, ClassExecutor> getClasses() {
        if (super.getClasses().isEmpty()) {
            ...
            load(V1_9_R2.class, "Entity:Ageable", new AgeableLivingEntity.AgeableLivingEntityClass("net.minecraft.server.v1_9_R2.EntityAgeable"));
            load(V1_9_R2.class, "Entity:Tameable", new TameableLivingEntity.TameableLivingEntityClass("net.minecraft.server.v1_9_R2.EntityTameableAnimal"));
            // EntityPlayer
            ...
            load(V1_9_R2.class, "WatchableObject", new WatchableObject.WatchableObjectClass("net.minecraft.server.v1_9_R2.DataWatcherObject"));
            //
    ...
    public @NotNull Map<String, Object> getObjects() {
        super.getObjects().put("Metadata:Player:SkinParts", 14);
