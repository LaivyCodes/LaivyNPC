...
public class V1_10_R1 extends V1_9_R2 {
    ...
    public void loadClasses() {
        ...
        load(V1_10_R1.class, "Entity:Human", new EntityHuman.EntityHumanClass("net.minecraft.server.v1_10_R1.EntityHuman"));
        ...
        load(V1_10_R1.class, "Entity:Zombie:Giant", new ZombieGiant.ZombieGiantClass("net.minecraft.server.v1_10_R1.EntityGiantZombie"));
        // EntityPlayer
